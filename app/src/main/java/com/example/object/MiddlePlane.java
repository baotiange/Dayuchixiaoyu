...
public class MiddlePlane extends EnemyPlane{
	...
	public static int sumCount = 15;	 	 	 //	对象总的数量
	...
	public void initial(int arg0,float arg1,float arg2){
		...
		object_y = ran.nextInt((int)(screen_width - object_width));
	...
	public void initBitmap() {
		...
		middlePlane = BitmapFactory.decodeResource(resources, R.drawable.b2);
